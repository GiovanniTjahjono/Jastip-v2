    ...
    <div class="card border-0">
        ...
        <div class="card-body">
            ...
            @endif
                <table class="table">
                    ...
                    <tbody >
                        ...
                        <tr>
                            ...
                            <td>
                            <form action="/hapus_gambar_request/{{$data->id}}/{{$data->id_request}}" method="post">
                                    @method('delete')
                                    @csrf
                ...
                <form method="post" enctype="multipart/form-data" action="/tambah_gambar_request">
                    @csrf
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <input type="text" hidden name="id_request" value="{{$gambars[0]->id_request}}">
                        </div>
                    </div>
                ...
                <div class="form-group row pull-right d-inline p-2">
                    <div class="col-sm-10">
                        <a href="/req/{{$gambars[0]->id_request}}/edit" class="btn btn-primary">Kembali</a>
                    </div>
                </div>
