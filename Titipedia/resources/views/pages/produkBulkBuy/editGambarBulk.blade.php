...
<div class="container mt-4 shadow-lg p-3 mb-5 bg-white rounded border-0">
    <div class="card border-0">
        ...
        <div class="card-body">
            ...
            <form method="post" enctype="multipart/form-data" action="/tambah_gambar_bulk">
                @csrf
                <div class="form-group row">
                    <div class="col-sm-10">
                        <input type="text" hidden name="id_bulkbuy" value="{{$gambars[0]->id_bulkbuy}}">
                    </div>
                </div>
                ...
                <div class="form-group row pull-right d-inline p-2">
                    <div class="col-sm-10">
                        <a href="/produk-bulk-buy/{{$gambars[0]->id_bulkbuy}}/edit" class="btn btn-primary">Kembali</a>
                    </div>
                </div>
