        ...
        <div class="card-body">
            <form method="post" enctype="multipart/form-data" action="/terjual/{{$penjualanPreorder->id}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('nomer_resi') is-invalid @enderror"
                            id="kode_transaksi" name="kode_transaksi" value="{{$penjualanPreorder->kode_transaksi}}">
                    </div>
                </div>
                <div class="form-group row">
